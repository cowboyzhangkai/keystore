package com.applet;
/**
 *  <b>日期：</b>2015年11月30日-上午10:42:58<br/>
 ...
 * <b>类名称：</b>SignCert<br/>
 * <b>类描述：</b>数字证书签名<br/>
 * <b>创建时间：</b>2015年11月30日 上午10:42:58<br/>
 * <b>备注：</b><br/>
 * 
 * @author cowboy <br />
 * @version 1.0.0<br/>
...
public class SignCert
{
	...
	{
		char[] storepass = "111111".toCharArray();
		// 存放CA证书和被签证书的证书库的访问密码
		char[] cakeypass = "111111".toCharArray();// CA数字证书条目的访问密码
		String alias = "missionCA";
		// CA证书在证书库中的别名，这个CA的证书用来签名其它的证书
		String name = "c:/keystore/abnerCALib";// 存放CA证书和被签证书的证书库的名字
		String newLib = "SignedLib";
		// 新证书库的名字，如果需要将签名后的证书放入新库，这是新库的名字
		char[] newLibPass = "100200".toCharArray();// 设置新库的访问密码
		String cerFileName = "c:/keystore/abnerCA.cer";// 被签证书的证书文件名
		String aliasName = "abnerCA";// 被签证书在证书库中的alias别名
		char[] namePass = "333333".toCharArray();
		// 被签证书的条目在证书库的私钥密码
		...
		char[] afterNewPass = "333333".toCharArray();
		...
		X509CertInfo cinfo_second = (X509CertInfo) cimp2.get(X509CertImpl.NAME + "." + X509CertImpl.INFO);
		...
		// X509CertInfo cinfo_second = (X509CertInfo)
		// cimp3.get(X509CertImpl.NAME + "." + X509CertImpl.INFO);
